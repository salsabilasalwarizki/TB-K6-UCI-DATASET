                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    ...
                                    <button type="button" onclick="quickAction('approve', {{ $ds->dataset_id }})" class="btn btn-outline-success" title="Approve">
                                        <i class="bi bi-check"></i>
                                    </button>
                                    @endif
                                    <button type="button" onclick="confirmDelete('{{ route('admin.datasets.destroy', $ds) }}')" class="btn btn-outline-danger" title="Delete">
...
function quickAction(action, id) {
    fetch(`{{ url('admin/datasets') }}/${id}/${action}`, {
        method:'POST', 
