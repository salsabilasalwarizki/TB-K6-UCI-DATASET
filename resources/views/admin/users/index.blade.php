        ...
        <div class="card stat-card border-warning h-100">
            <div class="card-body d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <h3 class="fw-bold mb-0">{{ $stats['unverified'] ?? 0 }}</h3>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div>
                                        <a href="{{ route('admin.users.edit', $user) }}" class="fw-semibold text-decoration-none">
                                            {{ $user->name }}
                                        </a>
                            ...
                            <td class="small text-muted">{{ $user->created_at?->format('M d, Y') ?? 'N/A' }}</td>
                            <td>
