...
<head>
    ...
    <meta name="description" content="@yield('meta_desc', 'UCI Machine Learning Repository')">
    <title>@yield('title', 'UCI Machine Learning Repository')</title>
...
@endauth
    <li class="nav-item">
        <a class="nav-link" href="{{ route('datasets.index') }}">Datasets</a>
    </li>
    ...
    <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu" aria-labelledby="contributeDropdown">
            <li>
                <a class="dropdown-item" href="{{ route('contribute.policy') }}">
            ...
            <li>
                <a class="dropdown-item" href="{{ route('contribute.linking.metadata') }}">
                    <div class="dropdown-item-content">
    ...
    <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu" aria-labelledby="aboutDropdown">
            <li>
                <a class="dropdown-item" href="{{ route('about.who-we-are') }}">
                    <div class="dropdown-item-content">
            ...
            <li><hr class="dropdown-divider"></li>
            <li>
                <a class="dropdown-item" href="{{ route('about.citation') }}">
                    <div class="dropdown-item-content">
            ...
            <li><hr class="dropdown-divider"></li>
            <li>
                <a class="dropdown-item" href="{{ route('about.contact') }}">
                    <div class="dropdown-item-content">
                ...
                @else
                    <a href="{{ route('login') }}" class="btn btn-sm" style="background-color: var(--uci-blue); color: white; border-radius: 6px;">
...
<footer>
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4 col-6 mb-4 mb-lg-0">
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="{{ route('datasets.index') }}">View Datasets</a></li>
                    <li><a href="{{ route('contribute.policy') }}">Donate a Dataset</a></li>
                </ul>
            </div>
        ...
        <div class="footer-copyright">
            <p class="mb-1">© {{ date('Y') }} UC Irvine Machine Learning Repository</p>
