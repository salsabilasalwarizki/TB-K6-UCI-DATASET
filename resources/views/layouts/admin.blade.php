...
<head>
    ...
    <title>@yield('title', 'Admin Dashboard') - UCI ML Repository</title>
    ...
    <div class="admin-main">
        ...
        <header class="admin-header">
            <div>
                ...
                <h5 class="d-none d-md-inline mb-0">@yield('page-title', 'Dashboard')</h5>
            </div>
            ...
            <div class="d-flex align-items-center gap-3">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li><a class="dropdown-item" href="{{ route('admin.datasets.index', ['status' => 'pending']) }}">
                            {{ $pendingCount }} dataset(s) pending review
                        </a></li>
                    </ul>
                </div>
