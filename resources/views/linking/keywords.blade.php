@extends('layouts.app')
@section('title', 'Link External Dataset - Keywords - UCI Machine Learning Repository')
...
<div class="linking-page">
    <div class="container">
        ...
        <!-- Form -->
        <form action="{{ route('contribute.linking.keywords.store') }}" method="POST">
            @csrf
            ...
            <div class="form-navigation">
                <a href="{{ route('contribute.linking.creators') }}" class="btn-back">
                    BACK
                </a>
