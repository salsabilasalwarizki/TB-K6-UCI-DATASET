@extends('layouts.app')
@section('title', 'Link External Dataset - Variable Info - UCI Machine Learning Repository')
...
<div class="linking-page">
    <div class="container">
        ...
        <!-- Form -->
        <form action="{{ route('contribute.linking.variable-info.store') }}" method="POST">
            @csrf
            ...
            <div class="form-card">
                ...
                <div class="form-group mb-4">
                    ...
                    >{{ old('class_labels', $data['class_labels'] ?? '') }}</textarea>
                ...
                <div class="form-group mb-4">
                    ...
                    >{{ old('variable_info', $data['variable_info'] ?? '') }}</textarea>
                    <small class="form-text text-muted">
            ...
            <div class="form-navigation">
                <a href="{{ route('contribute.linking.keywords') }}" class="btn-back">
                    BACK
                </a>
