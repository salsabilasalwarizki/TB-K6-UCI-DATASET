@extends('layouts.app')
@section('title', 'Link External Dataset - Creators - UCI Machine Learning Repository')
...
<div class="linking-page">
    <div class="container">
        ...
        <!-- Form -->
        <form action="{{ route('contribute.linking.creators.store') }}" method="POST">
            @csrf
            ...
            <div class="form-navigation">
                <a href="{{ route('contribute.linking.paper') }}" class="btn-back">
                    BACK
                </a>
