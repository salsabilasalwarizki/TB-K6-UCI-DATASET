@extends('layouts.app')
@section('title', 'Link External Dataset - Descriptive - UCI Machine Learning Repository')
...
<div class="linking-page">
    <div class="container">
        ...
        <!-- Form -->
        <form action="{{ route('contribute.linking.submit') }}" method="POST">
            @csrf
    ...
    <div class="form-group mb-4">
        ...
        <textarea 
            ...
            name="purpose" 
            rows="3"
            placeholder="Describe the main goal of this dataset...">{{ old('purpose', $data['purpose'] ?? '') }}</textarea>
    </div>
    ...
    <div class="form-group mb-4">
        ...
        <textarea 
            ...
            name="funding" 
            rows="2"
            placeholder="e.g., National Science Foundation, Internal Grant, None">{{ old('funding', $data['funding'] ?? '') }}</textarea>
    </div>
    ...
    <div class="form-group mb-4">
        ...
        <textarea 
            ...
            rows="2"
            placeholder="e.g., patients, photos, transactions, sensor readings...">{{ old('instances_represent', $data['instances_represent'] ?? '') }}</textarea>
    ...
    <div class="form-group mb-4">
        ...
        <textarea 
            ...
            name="data_splits" 
            rows="2"
            placeholder="e.g., 70% training, 30% testing">{{ old('data_splits', $data['data_splits'] ?? '') }}</textarea>
    ...
    <div class="form-group mb-4">
        ...
        <textarea 
            ...
            name="sensitive_data" 
            rows="3"
            placeholder="Describe any sensitive data...">{{ old('sensitive_data', $data['sensitive_data'] ?? '') }}</textarea>
    ...
    <div class="form-group mb-4">
        ...
        <textarea 
            ...
            name="preprocessing" 
            rows="3"
            placeholder="Describe preprocessing steps...">{{ old('preprocessing', $data['preprocessing'] ?? '') }}</textarea>
    ...
    <div class="form-group mb-4">
        ...
        <textarea 
            ...
            rows="3"
            placeholder="Any other details...">{{ old('additional_info', $data['additional_info'] ?? '') }}</textarea>
    ...
    <div class="form-group mb-4">
        ...
        <textarea 
            ...
            rows="3"
            placeholder="e.g., Please cite this dataset as...">{{ old('citation_requests', $data['citation_requests'] ?? '') }}</textarea>
    ...
    <div class="summary-box p-3 bg-light border rounded mt-4">
        ...
        <p class="small text-muted mb-0">
            <strong>Dataset Name:</strong> {{ $data['name'] ?? 'N/A' }}<br>
            <strong>External URL:</strong> <a href="{{ $data['external_url'] ?? '#' }}" target="_blank" class="text-truncate d-inline-block" style="max-width: 300px;">{{ $data['external_url'] ?? 'N/A' }}</a><br>
            <strong>Subject Area:</strong> {{ $data['subject_area'] ?? 'N/A' }}
        </p>
    </div>
</div>
            ...
            <div class="form-navigation">
                <a href="{{ route('contribute.linking.variable-info') }}" class="btn-back">
                    BACK
                </a>
